...
import { Star, Crown, Loader2, ThumbsUp, Search, Globe, MessageSquare } from 'lucide-react';
...
const Top50 = () => {
  ...
  return (
    <>
      <SEOHead
        title={`Top Voted MU Online Servers - ${monthName} ${currentYear} | MU Online Hub`}
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="container mx-auto px-4 py-6">
          <div className="text-center mb-8">
            <h1 className="font-display text-2xl md:text-3xl font-bold text-gradient-gold uppercase tracking-wide">
              Top Voted Servers This Month
            </h1>
            <p className="text-sm text-muted-foreground mt-2">
              {monthName} {currentYear} — vote once per server this month.
            </p>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="space-y-1.5">
              {rankedServers.map((server, index) => {
                ...
                const websiteHref = normalizeExternalUrl(server.website);
                const discordHref = normalizeExternalUrl(server.discord_link);
